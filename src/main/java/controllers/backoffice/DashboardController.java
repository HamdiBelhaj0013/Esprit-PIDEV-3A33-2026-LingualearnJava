...
public class DashboardController {
    ...
    public void showCommentaires() {
        setActiveBtn(btnCommentaires);
        loadView("/backoffice/fxml/commentaire_manager.fxml");
    }
    ...
    private void setActiveBtn(Button active) {
        ...
        btnCommentaires.setStyle(btnCommentaires == active ? "-fx-background-color: #2563eb; -fx-text-fill: white; -fx-font-weight: bold;" : "-fx-background-color: transparent; -fx-text-fill: #cbd5e1;");
    }
