...
public class FrontCoursesController {
    ...
    public void initialize() {
        backToLanguagesLabel.setOnMouseClicked(e -> FrontRouter.goTo("/fxml/modules/frontoffice/front-languages.fxml"));
    ...
    private VBox createCourseCard(Course course) {
        ...
        btnStart.setOnAction(e -> {
            ...
            FrontRouter.goTo("/fxml/modules/frontoffice/front-lessons.fxml");
        });
