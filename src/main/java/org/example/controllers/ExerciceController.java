...
public class ExerciceController {
    ...
    private void renderGrid(List<Exercice> exercises) {
        ...
        for (Exercice ex : exercises) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ExerciceCard.fxml"));
    ...
    private void viewExercice(Exercice ex) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ExerciceDetailView.fxml"));
    ...
    private void navigateToForm(Exercice ex) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ExerciceForm.fxml"));
            Parent root = loader.load();
