...
public class SidebarController {
    ...
    private void goToQuizzes() {
        switchScene("/fxml/QuizView.fxml", "Quiz Management");
    }

    @FXML
    private void goToExercises() {
        switchScene("/fxml/admin/ExerciceView.fxml", "Exercise Management");
    }

    @FXML
    private void goToStats() {
        switchScene("/fxml/StatsView.fxml", "Statistics");
    }
    ...
    private void handleLogout() {
        switchScene("/fxml/LoginView.fxml", "Login - LinguaLearn");
    }
}
