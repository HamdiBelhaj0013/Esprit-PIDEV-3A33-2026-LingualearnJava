...
public class ExerciceController {
    ...
    private void viewExercice(Exercice ex) {
        if (ex.getDifficulty() >= 4 && !(org.example.util.SessionManager.getCurrentUser() != null && org.example.util.SessionManager.getCurrentUser().hasRole("ROLE_ADMIN"))) {
        ...
        try {
            ...
            StackPane contentArea = (StackPane) exerciceGrid.getScene().lookup("#contentArea");
            if (contentArea != null) {
