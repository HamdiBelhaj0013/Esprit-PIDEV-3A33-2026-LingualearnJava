...
public class CommentaireBackofficeController {
    ...
    public void openAddPage() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/forum/fxml/commentaire_new.fxml"));
    ...
    public void openShowPage() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/admin/forum/fxml/commentaire_show.fxml"));
            Parent root = loader.load();
