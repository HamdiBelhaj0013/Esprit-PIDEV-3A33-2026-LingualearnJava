 ...
 * Utilise la configuration validÃ©e de l'Ã©quipe (benali.mohamedzh@gmail.com).
 */
    ...
    public static void sendBadWordWarning(String commentContent, String publicationTitle) {
        new Thread(() -> {
            try {
                ...
                message.setFrom(new InternetAddress(FROM_EMAIL, "LinguaLearn ModÃ©ration"));
                message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(ADMIN_EMAIL));
                message.setSubject("âš ï¸ Commentaire inappropriÃ© dÃ©tectÃ© - LinguaLearn");
                ...
                String htmlBody = """
                    ...
                    <table width="560" style="background:white;border-radius:16px;overflow:hidden;
                      ...
                      <tr><td style="background:linear-gradient(135deg,#e74c3c,#c0392b);
                        ...
                        <h1 style="color:white;margin:0;font-size:26px;">ðŸ›¡ï¸ LinguaLearn</h1>
                        <p style="color:#ffc9c9;margin:6px 0 0;font-size:15px;">SystÃ¨me de ModÃ©ration</p>
                      </td></tr>
                      <tr><td style="padding:28px 40px 0;text-align:center;">
                        <h2 style="color:#e74c3c;font-size:20px;margin:0;">âš ï¸ Commentaire inappropriÃ© bloquÃ©</h2>
                        <p style="color:#64748b;font-size:13px;margin:8px 0 0;">Un commentaire a Ã©tÃ© automatiquement bloquÃ© par le systÃ¨me.</p>
                      </td></tr>
                      <tr><td style="padding:20px 40px 24px;">
                        <div style="background:#fff8f8;border-radius:12px;padding:20px;
                          ...
                          <p style="color:#475569;font-size:13px;margin:0 0 10px;">
                            <strong>ðŸ“Œ Publication :</strong> %s
                          </p>
                          <p style="color:#475569;font-size:13px;margin:0;">
                            <strong>ðŸ’¬ Commentaire bloquÃ© :</strong>
                          </p>
                      ...
                      <tr><td style="padding:0 40px 28px;text-align:center;">
                        <p style="color:#475569;font-size:14px;line-height:1.7;margin:0;">
                          Ce commentaire <strong>n'a pas Ã©tÃ© publiÃ©</strong>.<br>
                          Veuillez prendre les mesures nÃ©cessaires si besoin.
                        </p>
                      </td></tr>
                      <tr><td style="background:#f8fafc;padding:16px 40px;text-align:center;
                                     border-top:1px solid #e2e8f0;">
                        <p style="color:#94a3b8;font-size:12px;margin:0;">
                          Â© 2026 LinguaLearn â€” SystÃ¨me de modÃ©ration automatique
                        </p>
                      </td></tr>
                    </table>
                    </td></tr></table>
                ...
                System.out.println("âœ… Email d'avertissement envoyÃ© Ã  " + ADMIN_EMAIL);

            } catch (Exception e) {
                System.out.println("âŒ Erreur envoi email : " + e.getMessage());
                e.printStackTrace();
            }
        }).start();
    }
